...
public class FiveDayForecastAdapter extends RecyclerView.Adapter<FiveDayForecastAdapter.MyViewHolder> {

    Context context;


    public FiveDayForecastAdapter(Context context, Root root) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        int weatherIconNumber = root.dailyForecasts.get(position).day.icon;
        ...
        holder.tvForecastCondition.setText(root.dailyForecasts.get(position).day.iconPhrase);
